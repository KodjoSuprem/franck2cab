...
yt-dlp --download-archive download_archive.txt -f bestaudio yt-dlp --parse-metadata "description:(?s)(?P<meta_comment>.+)" --embed-metadata --extract-audio --audio-format mp3 --embed-thumbnail --output "%(title)s.%(ext)s" "$URL" 
