...
yt-dlp --no-mtime --download-archive download_archive.txt -f bestaudio --embed-metadata --extract-audio --audio-format mp3 --embed-thumbnail --output "%(title)s.%(ext)s" "$URL"
